...
$sql1 = "SELECT ID FROM university WHERE state = 'on'";
        ...
        $sql2 = "SELECT ID_Trip FROM trip WHERE Name_Trip = 'Madaen saleh'";
...
$sql="INSERT INTO  student_trip (ID_Trip,ID ,Transportation,Paymentmethod,Accountnumber) VALUES('$Trip_ID','$ID','$transportation','$method','$accNum') ";
    ...
    echo "Error: " . $sql . "<br>" . $conn->error;
             ...
             echo "<script type='text/javascript'>alert('YOU CANNOT REGISTER IN THIS TRIP BECAUSE YOU ARE NOT FROM THE HISTORY DEPARTMENT');</script>";
        }
         }
        }
        else{
	...
	<div id="wrapper">
		...
		<div class="inner">
			...
			<li><a href="#Instagram" class="icon fa-instagram"><span class="label">Instagram</span></a></li>
                    ...
                    <!-- Content -->
                    <div id="page">
			<h2 id="content">Madaen Saleh</h2>
                        <p>registration in trip to Madaen Saleh .We organized the trip for you and we hope you fill out the form accurately.</p>
 			<!-- Form -->
