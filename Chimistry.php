...
<html>
	...
	<div id="wrapper">
      ...
      <?php 
        $date = date("Y-m-d");
        $sql = "SELECT * FROM trip WHERE Department_Trip='Chemistry' AND Date >'$date'";
...
<td><a href="RegisterChimistry.php" name="register" >Register</a></td>
<td><a href="Chimistry.html">More</a></td>
</tr>
<?php }
} else {
...
?>
      ...
      <?php 
        $sql1 = "SELECT * FROM trip WHERE Department_Trip='Chemistry' AND Date < '$date'";
...
<td><?php echo $row['Studentsnumber'] ?></td>
<td><?php echo $row['Price'] ?></td>
<td><a href="previousTripsChimistry.html">More</a></td>
</tr>
<?php }
} else {
