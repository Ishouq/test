...
<html>
	...
	<body>
      ...
      <?php 
        $date = date("Y-m-d");
        $sql = "SELECT * FROM trip WHERE Department_Trip='History' AND Date >'$date'";
...
<td><a href="RegisterHistory.php" name="register" >Register</a></td>
<td><a href="History.html">More</a></td>
</tr>
<?php }
} else {
...
?>
      ...
      <?php 
        $sql1 = "SELECT * FROM trip WHERE Department_Trip='History' AND Date < '$date'";
...
<td><?php echo $row['Studentsnumber'] ?></td>
<td><?php echo $row['Price'] ?></td>
<td><a href="previousTripsHistory.html">More</a></td>
</tr>
<?php }
} else {
