...
<!-- Banner -->
					...
					<div class="content">
					<header>
					<h1><strong>Kindergarten</strong></h1>
                                         <header class="major">
					<h2>New trips</h2>
			            	</header>
      ...
      <?php 
        $date = date("Y-m-d");
        $sql = "SELECT * FROM trip WHERE Department_Trip='kindergarten' AND Date >'$date'";
...
<td><a href="RegisterKindergarten.php" name="register" >Register</a></td>
<td><a href="Kindergarten.html">More</a></td>
</tr>
<?php }
} else {
...
?>
      ...
      <?php 
        $sql1 = "SELECT * FROM trip WHERE Department_Trip='kindergarten' AND Date < '$date'";
...
<td><?php echo $row['Studentsnumber'] ?></td>
<td><?php echo $row['Price'] ?></td>
<td><a href="previousTripsKindergarten.html">More</a></td>
</tr>
<?php }
} else {
